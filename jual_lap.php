...
<!-- input-forms -->
                <div class="grids">
                    <div class="progressbar-heading grids-heading">
                       <h2> LAPORAN PENCATATAN PERHITUNGAN PENJUALAN PER PERIODE </h2>
                    </div>
                ...
                <!-- tables -->
                                ...
                                <?php  
                                            $sql_cek="select *  FROM penjualanreguler r join  barang q  
                        on  (q.kd_brg=r.kd_brg) )";
      ...
      <table class="table table-bordered">
            ...
            <th>Harga Barang</th>
            <th>Komisi</th>
            <th>Jumlah yang seharusnya diterima</th>
            <th>Piutang</th>
            <th>Hapus</th>
            <th>Lihat Jurnal</th>
                       ...
                       <?php 
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                 <ul class="bt-list">
                                              <li><a href=baranghapus.php?id_jual=<?php echo $data['id_jual']; ?> class="hvr-icon-fade col-7">Hapus</a></li>
                                                </ul>
                                            </td>
                                            <td>
                                                 <ul class="bt-list">
