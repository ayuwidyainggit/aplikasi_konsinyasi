...
$sql_data="SELECT * FROM kirimselesai r join toko q 
                    on  (q.id_toko=r.id_toko)   where id_kirim='$id_kirim'";
...
<center><h2>PT ABC</h2></center>
					<center><h2>Bukti Pengiriman Barang Konsinyasi</h2></center>
				</div>
				...
				<div class="agile-tables">
                    ...
                    on  (q.kd_brg=r.kd_brg)   where id_kirim='$id_kirim'");
      ...
      <table class="table-responsive">
						<thead>
											<tr>
                                                <td colspan="4">TUJUAN : <?php echo $data['nm_toko']; ?></td>
                                                <td colspan="3">NO Pengiriman : <?php echo $data['id_kirim']; ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="4"></td>
                                                <td colspan="3">Tgl Kirim : <?php echo $data['tgl_kirim']; ?></td>
                                            </tr>
                                            <tr>
           ...
           <tr>
                                                ...
                                                <td><?php echo $data1['jml_kirim']; ?></td>
                                                 ...
                                                 <td>Rp <?php echo number_format($data1['hrg_jual_brg'], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
                                                <td>Rp <?php echo number_format($data1['hrg_jual_brg']*$data1['jml_kirim'  ], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
          ...
          <?php  
                    ...
                    $id_kirim = $_GET['id_kirim']; 
                                        ...
                                        $sql_cek1=("SELECT sum(hrg_jual_brg * jml_kirim) as a  FROM kirimdetail r join barang q 
                                        on  (q.kd_brg=r.kd_brg)   where id_kirim='$id_kirim'");
