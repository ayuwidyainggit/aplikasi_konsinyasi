...
$sqlku="SELECT * from jurnalumum where bukti='$id_jual'";
$hasilku = $koneksidb->query($sqlku);
$dataku = $hasilku->fetch_array();
?>
...
<div class="table-heading">
					<h2>Jurnal Perhitungan Penjualan Konsinyasi</h2>
				</div>
				<div class="agile-tables">
					<div class="w3l-table-info">
					 ...
					 <?php  
                                $sql_cek="select b.* , a.nm_akun from jurnalumum b, akun a where b.bukti='$id_jual' order by no_ju";
                                        ...
                                        echo "<center>Maaf Data Yang anda cari tidak ada <br> Silahkan Masukkan Data Terlebih Dahulu</center>";
                                            ...
                                            $total=mysql_query("select sum(total_debet) as tot_debet, sum(total_kredit) as tot_kredit from jurnalumum");
