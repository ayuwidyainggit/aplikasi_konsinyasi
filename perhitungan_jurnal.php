...
join akun C
on(b.no_ju=a.no_ju) AND (c.kd_akun=A.kd_akun) where bukti='$id_jual'  order by A.no_ju");
...
<?php  
                    ...
                    $id_jual = $_GET['id_jual']; 
                                        ...
                                        $sql_cek1=("SELECT sum(total_debet) as totaldebet from detail_jurnal j join jurnalumum p on (p.no_ju=j.no_ju) where  bukti='$id_jual'");
                    ...
                    $id_jual = $_GET['id_jual']; 
                                        ...
                                        $sql_cek=("SELECT sum(total_kredit) as totalkredit from detail_jurnal j join jurnalumum p on (p.no_ju=j.no_ju) where  bukti='$id_jual'");
