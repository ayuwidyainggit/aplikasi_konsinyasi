...
<?php
 ...
 $akun          ="SELECT nm_akun from akun where kd_akun = '$kd_akun'";
					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
									<form action="akun_edit_res.php" method="post"> 
										<div class="form-group"> 
											<label for="exampleInputEmail1">Kode Akun</label> 
											<input type="text" class="form-control" value ="<?php echo $kd_akun?>" name="kd_akun" readonly>
										</div> 
										<div class="form-group"> 
										...
										<div class="form-group"> 
											...
											<input type="text" class="form-control"  name="nm_akun" required <?php
                                                       while ($nama_tampil=mysqli_fetch_assoc($akun_query)){
                                                       echo "<option value='".$nama_tampil['nm_akun']."'>"."</option>";
                                                        }
                                                    ?>  
										</div> 
