...
<head>
                        ...
                        <div class="forms">
                            <div class="form-two widget-shadow">
                                ...
                                <div class="form-body" data-example-id="simple-form-inline">
                                    <form class="form-inline" action="lr_periode.php" method="post"> 
  ...
  <?php                                          
                                        ...
                                        from terimapenjualan t join penjualan p on (p.id_jual=t.id_jual)");
                                        ...
                                        if($result_cek=='0'){
                                            ...
                                            ?> 
                                               ...
                                               <?php                                          
                                        $sql_cek2=("
                                        SELECT sum(biaya_kirim ) as biaya from kirimdetail k join kirimselesai a on (a.id_kirim=k.id_kirim)  ");
