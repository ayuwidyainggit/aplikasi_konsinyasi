...
if ($tgl_awal >  date($_POST['tgl_akhir'])){
    echo "<SCRIPT language=Javascript>
        ...
        <script>window.location='kirim_lap.php'</script>";
           ...
           <div class="forms">
               <div class="form-two widget-shadow">
                   ...
                   <div class="form-body" data-example-id="simple-form-inline">
                       <form class="form-inline" action="cetak_kirim.php" target="_blank" method="post"> 
                ...
                <!-- tables -->
                  ...
                  <?php  
                            ...
                            $tgl_akhir            = $_POST['tgl_akhir'];
                                        ...
                                        $sql_cek=("SELECT * FROM kirimselesai r join  toko q 
                    on  (q.id_toko=r.id_toko)  Where (tgl_kirim BETWEEN '$tgl_awal' AND '$tgl_akhir') order by id_kirim asc");
                         ...
                         <?php 
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>Rp <?php echo number_format($data['totalkirim'], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>

                                               <td class="text-primary">
                                                     <a title="Lihat Faktur Penjualan" href=kirim_faktur.php?id_kirim=<?php echo $data['id_kirim']; ?>>CEK</a>
                                                </td>
                                                <td class="text-primary">
                                                     <a title="Lihat Faktur Penjualan" href=jurnalkirim.php?id_kirim=<?php echo $data['id_kirim']; ?>>Lihat</a>
                                                </td>
                                            ...
                                            <!-- <tr>
                                                ...
                                                <td colspan="3">Rp <?php echo number_format($data['total'], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
                                ...
                                $tgl_akhir            = $_POST['tgl_akhir'];
                                        ...
                                        $sql_cek1=("SELECT sum(totalkirim) as total FROM kirimselesai r join  toko q 
                    on  (q.id_toko=r.id_toko)   Where (tgl_kirim BETWEEN '$tgl_awal' AND '$tgl_akhir') order by id_kirim asc");
