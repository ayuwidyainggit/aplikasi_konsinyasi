...
<body class="dashboard-page">
        ...
        <ul>
            ...
            <li class="has-subnav">
                ...
                <ul>
                    ...
                    <li>
                        <a class="subnav-text" href="rekening_lap.php">Daftar Rekening</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="has-subnav">
             ...
             <li class="has-subnav">
                ...
                <ul>
                    ...
                    <li>
                        <a class="subnav-text" href="barang_lap.php">Barang Konsinyasi</a>
                    </li>
                    <li>
                        <a class="subnav-text" href="barangmasuk_lap.php">Pemasukan Barang</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="has-subnav">
                ...
                <ul>
                    <li>
                        <a class="subnav-text" href="pengiriman.php">Input Data Pengiriman </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="subnav-text" href="returkirim.php">Input Data Retur pengiriman  </a>
                    </li>
                    <li>
            ...
            <li class="has-subnav">
                ...
                <ul>
                    ...
                    <li>
                     ...
                     <li>
                        <a class="subnav-text" href="retur_lap.php">
                            laporan Retur Pengiriman 
                        </a>
                    </li>
    ...
    <section class="wrapper scrollable">
        ...
        <section class="title-bar">
            <div class="logo">
                <h1><a href="index.html"><img src="images/logo.png" alt="" />Konsinyasi</a></h1>
            </div>
