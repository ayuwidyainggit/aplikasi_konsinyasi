...
<?php
 ...
 $toko          ="SELECT * from toko where id_toko = '$id_toko'";
 $toko_query    = mysqli_query($koneksidb,$toko); 
 
?>
<?php

 $alamat          ="SELECT alamat from toko where id_toko = '$id_toko'";
 $alamat_query    = mysqli_query($koneksidb,$alamat); 
...
<?php
 ...
 $hp          ="SELECT no_telp from toko where id_toko = '$id_toko'";
 $hp_query    = mysqli_query($koneksidb,$hp); 
 
?>

<?php

 $komisi         ="SELECT komisi from toko where id_toko = '$id_toko'";
					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
									<form action="toko_edit_res.php" method="post"> 
										<div class="form-group"> 
											<label for="exampleInputEmail1">Id Toko</label> 
											<input type="text" class="form-control" value ="<?php echo $id_toko?>" name="id_toko" readonly>
										</div> 
										

										<div class="form-group"> 
											<label for="exampleInputEmail1">Nama Toko </label> 
											 <input type="text" class="form-control"  name="nm_toko" required <?php
                                                       while ($nama_tampil=mysqli_fetch_assoc($toko_query)){
                                                       echo "<option value='".$nama_tampil['nm_toko']."'>"."</option>";
                                                        }
                                                    ?>  
										</div> 
										...
										<div class="form-group"> 
											<label for="exampleInputEmail1">Alamat </label> 
                                             ...
                                             <?php
                                                       while ($alamat_tampil=mysqli_fetch_assoc($alamat_query)){
                                                       echo "<option value='".$alamat_tampil['alamat']."'>"."</option>";
                                                        }
                                                    ?>  
										</div> 
										...
										<div class="form-group"> 
                                            ...
                                            <?php
                                                       while ($telp_tampil=mysqli_fetch_assoc($hp_query)){
                                                       echo "<option value='".$telp_tampil['no_telp']."'>"."</option>";
                                                        }
                                                    ?>  
										</div> 
										...
										<div class="form-group"> 
											...
											<input type="number" class="form-control"  name="komisi" readonly=""
                                            <?php
