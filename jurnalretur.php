...
<head>
				...
				<div class="table-heading">
					<h2>Jurnal Pengiriman Barang Konsinyasi dan Jurnal Pembebanan Biaya</h2>
				</div>
...
join akun C
on(b.no_ju=a.no_ju) AND (c.kd_akun=A.kd_akun) where bukti='$kd_retur'  order by A.no_ju");
...
<?php  
                    ...
                    $kd_retur = $_GET['kd_retur']; 
                                        ...
                                        $sql_cek1=("SELECT sum(total_debet) as totaldebet from detail_jurnal j join jurnalumum p
                                         on (p.no_ju=j.no_ju) where  bukti='$kd_retur'");
                    ...
                    $kd_retur = $_GET['kd_retur']; 
                                        ...
                                        $sql_cek=("SELECT sum(total_kredit) as totalkredit from detail_jurnal j join jurnalumum p 
                                        on (p.no_ju=j.no_ju) where  bukti='$kd_retur'");
