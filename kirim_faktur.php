...
<div class="table-heading">
					<h2>PT ABC</h2>
                    <h2>Bukti Pengiriman Barang Konsinyasi</h2>
				</div>
             
                <ul class="bt-list">
                <li><a href=cetak_kirimfaktur.php?id_kirim=<?php echo $data['id_kirim']; ?> class="hvr-icon-fade col-7"  target="_blank">Cetak</a></li>
                </ul>
