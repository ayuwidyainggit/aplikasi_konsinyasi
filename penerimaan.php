...
$sql_data="SELECT * FROM penjualan r join toko q 
                    on  (q.id_toko=r.id_toko)   where id_jual='$bukti'";
...
<h2>PT ABC </h2>
  ...
  <?php    
    ...
    $sql_cek=("SELECT * FROM detailjual r join barang q  
                    on  (q.kd_brg=r.kd_brg)  where r.id_jual='$bukti'");
      ...
      <table class="table-responsive">
            <thead>
                      ...
                      <tr>
                                            ...
                                            <tr>
                                                <td colspan="3">Komisi  : <?php echo $data1['komisi']; ?> %</td>
                                                <td></td>
                                                <td></td>
           ...
           <?php 
                    ...
                    $bukti = $_GET['bukti']; 
                                        ...
                                        $sql_cek1=("SELECT sum(hrg_jual_brg) as a, sum(hasil_komisi) as b, sum(kas_diterima) as c, sum(hrg_pokok_brg) as d  FROM detailjual r join barang q  
                                        on  (q.kd_brg=r.kd_brg)  where r.id_jual='$bukti'");
