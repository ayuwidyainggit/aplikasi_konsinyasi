...
join akun C
on(b.no_ju=a.no_ju) AND (c.kd_akun=A.kd_akun) where bukti like 'KM%' order by A.no_ju");
            ...
            <th>Kredit</th>
                        ...
                        <?php 
                                      ...
                                      while($row = mysql_fetch_array($sql)) {       
                                        ...
                                        echo "<a href='km_bukti.php?bukti=" . $row['bukti'] . " '>CEK </a>";
                                        $jum = $row['jumlah'];       
                                        $no++;                     
                                        } else {
                                        $jum = $jum - 1;
...
<?php  
                                        ...
                                        $sql_cek1=("SELECT sum(total_debet) as totaldebet from detail_jurnal d join jurnalumum c on (c.no_ju=d.no_ju)  where bukti like 'KM%'");
                                ...
                                ?>
                                    ...
                                    <?php  
                                        ...
                                        $sql_cek=("SELECT sum(total_kredit) as totalkredit from detail_jurnal d join jurnalumum c on (c.no_ju=d.no_ju)  where bukti like 'KM%' ");
